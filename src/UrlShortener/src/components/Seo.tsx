...
const defaultMeta = {
  ...
  type: 'website',
  robots: 'follow, index',
  image: 'https://adison.me/images/large-og.png',
};
...
export default function Seo(props: SeoProps) {
  ...
  // TODO: Follow config for opengraph, by deploying one on https://github.com/theodorusclarence/og
